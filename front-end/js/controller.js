...
$scope.loginForm = function(){
	$http.post('http://willybman.com:3002/login', {
...
$scope.registerForm = function(){
	if($scope.password == $scope.password2){
		$http.post('http://willybman.com:3002/register', {
			username: $scope.username,
			password: $scope.password,
			email: $scope.email
		}).then(function successCallback(response){
...
$scope.logout = function(){
    ...
    $http.post('http://willybman.com:3002/logout', {
    	username: $scope.username,
    	turn: turn,
    	bank1: bank1,
    	property1: property1,
...
var socketio = io.connect('http://willybman.com:3001');
